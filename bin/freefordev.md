...
## Major Cloud Providers
  ...
  * [Google Cloud Platform](https://cloud.google.com)
    * [App Engine](https://cloud.google.com/appengine) - 28 frontend instance hours per day, nine backend instance hours per day
    * [Cloud Firestore](https://cloud.google.com/firestore) - 1GB storage, 50,000 reads, 20,000 writes, 20,000 deletes per day
    * [Compute Engine](https://cloud.google.com/compute) - 1 non-preemptible e2-micro, 30GB HDD, 5GB snapshot storage (restricted to certain regions), 1 GB network egress from North America to all region destinations (excluding China and Australia) per month
    * [Cloud Storage](https://cloud.google.com/storage) - 5GB, 1GB network egress
    * [Cloud Shell](https://cloud.google.com/shell) - Web-based Linux shell/primary IDE with 5GB of persistent storage. 60 hours limit per week
    * [Cloud Pub/Sub](https://cloud.google.com/pubsub) - 10GB of messages per month
    * [Cloud Functions](https://cloud.google.com/functions) - 2 million invocations per month (includes both background and HTTP invocations)
    * [Cloud Run](https://cloud.google.com/run) - 2 million requests per month, 360,000 GB-seconds memory, 180,000 vCPU-seconds of compute time, 1 GB network egress from North America per month
    * [Google Kubernetes Engine](https://cloud.google.com/kubernetes-engine) - No cluster management fee for one zonal cluster. Each user node is charged at standard Compute Engine pricing
    * [BigQuery](https://cloud.google.com/bigquery) - 1 TB of querying per month, 10 GB of storage each month
    * [Cloud Build](https://cloud.google.com/cloud-build) - 120 build-minutes per day
    * [Cloud Source Repositories](https://cloud.google.com/source-repositories) - Up to 5 Users, 50 GB Storage, 50 GB Egress
  ...
  * [Oracle Cloud](https://www.oracle.com/cloud/)
    ...
    * [Block Volume](https://www.oracle.com/cloud/storage/block-volumes/) - 2 volumes, 200 GB total (used for compute)
    * [Object Storage](https://www.oracle.com/cloud/storage/object-storage/) - 10 GB
    * [Load balancer](https://www.oracle.com/cloud/networking/load-balancing/) - 1 instance with 10 Mbps
    * [Databases](https://www.oracle.com/database/) - 2 DBs, 20 GB each
    * [Monitoring](https://www.oracle.com/cloud/monitoring/) - 500 million ingestion data points, 1 billion retrieval datapoints
    * [Bandwidth](https://www.oracle.com/cloud/networking/) - 10 TB egress per month, speed limited to 50 Mbps on x64-based VM, 500 Mbps * core count on ARM-based VM
    * [Public IP](https://www.oracle.com/cloud/networking/ip-addresses/) - 2 IPv4 for VMs, 1 IPv4 for load balancer
    * [Notifications](https://www.oracle.com/cloud/cloud-native/notification-service/) - 1 million delivery options per month, 1000 emails sent per month
    * Full, detailed list - https://www.oracle.com/cloud/free/

  * [IBM Cloud](https://www.ibm.com/cloud/free/)
    * [Cloudant database](https://www.ibm.com/cloud/cloudant) - 1 GB of data storage
    * [Db2 database](https://www.ibm.com/cloud/db2) - 100MB of data storage
    * [API Connect](https://www.ibm.com/cloud/api-connect) - 50,000 API calls per month
    * [Availability Monitoring](https://www.ibm.com/cloud/availability-monitoring) - 3 million data points per month
    * [Log Analysis](https://www.ibm.com/cloud/log-analysis) - 500MB of daily log
...
## Code Quality
  ...
  * [CodeBeat](https://www.codebeat.co) — Automated Code Review Platform available for many languages. Free forever for public repositories with Slack and e-mail integration.
...
## Analytics, Events and Statistics
  ...
  * [Statsig](https://statsig.com) - All-in-one platform spanning across analytics, feature flagging, and A/B testing. Free for up to 1m metered events per month. Also provides unlinited in-App Surveys with 250/month responses.
...
## Miscellaneous
  ...
  * [snappify](https://snappify.com) — Create and edit screen recordings and other videos online.
